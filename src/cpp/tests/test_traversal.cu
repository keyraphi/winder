...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        ...
        WinderTestParams{"MediumSceneSingleQuery", 1024, 1, 5.F, 5.F, 5.F,
                         1.F / 250.F, 2.3F, 1e-2},
        WinderTestParams{"MediumScene", 1024, 100, 5.F, 5.F, 20.F, 1.F / 250.F,
                         2.3F, 1e-2},
        WinderTestParams{"MediumSceneSmallEpsilon", 1024, 100, 5.F, 5.F, 20.F,
                         1.F / 1000.F, 2.3F, 1e-2},
        WinderTestParams{"MediumSceneBigEpsilon", 1024, 100, 5.F, 5.F, 20.F,
                         1.F / 2.F, 2.3F, 1e-2},
        WinderTestParams{"LargeSceneSingleQuery", 1000000, 1, 50.F, 5.F, 20.F,
                         1.F / 250.F, 2.3F, 1e-2},
        WinderTestParams{"LargeScene", 1000000, 1000, 50.F, 5.F, 20.F,
                         1.F / 250.F, 2.3F, 1e-2},
        WinderTestParams{"LargeSceneSingleQueryLargeBeta", 1000000, 1, 50.F,
                         5.F, 20.F, 1.F / 250.F, 5.F, 1e-2},
        WinderTestParams{"LargeSceneLargeBeta", 1000000, 1000, 50.F, 5.F, 20.F,
                         1.F / 250.F, 5.F, 1e-2}),
